...
public class MailServiceTests {
    ...
    class sendTest{
        ...
        public void sendFailUnsupportMailTest() throws MessagingException, UnsupportedEncodingException {
            //given
            String mail = "test@test.com";
    ...
    class AuthKeyConfirmTest{
        ...
        public void failAuthKeyConfirmByAuthKeyExpire(){
            ...
            //when then
            Assertions.assertThatThrownBy(()->mailService.checkAuthKey(mail, authKey)).isInstanceOf(AuthKeyExpireException.class);
        }
    }
}
